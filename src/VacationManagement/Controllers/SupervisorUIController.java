...
public class SupervisorUIController {
    ...
    private void searchHistorByID(){
       ...
       if(text.isEmpty() || text.trim().isEmpty()) {
           ...
           if(isNumeric(text)){
               loadTableHistoryRequest(VacRequestSearch.searchAllByEmployeeID(Integer.valueOf(text),supervisorID));
           }
       }
    }
    ...
    private void loadTableHistoryRequest(){
        vacRequests=FXCollections.observableArrayList(VacRequestRead.getRequestHistory(supervisorID));
    ...
    private void loadTableHistoryRequest(List<VacRequest> vacHistoryList){
    ...
    private void loadTablePendingRequest(){
        vacRequests=FXCollections.observableArrayList(VacRequestRead.getPendingRequest(supervisorID));
